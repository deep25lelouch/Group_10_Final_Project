...
public class SafetyEnvironmentEnterpriseAdminRole extends Role {
    public SafetyEnvironmentEnterpriseAdminRole() { super(RoleType.SAFETY_ENVIRONMENT_ENTERPRISE_ADMIN); }
